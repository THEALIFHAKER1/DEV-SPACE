...
const LiveIsland = (props: LiveIslandProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`live-island absolute left-1/2 top-0 h-[--small-height] w-[--small-width] rounded-[--small-height] bg-black text-white [box-shadow:inset_0_0_0_1.5px_rgb(255_255_255/0.15),0_1px_2px_rgb(0_0_0/0.2)] [transform:translate(-50%)_scale(var(--scale,1))] [&>*]:duration-200 ${className} ${
          isSmall
