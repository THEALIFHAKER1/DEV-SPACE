...
const data = [
  {
    ...
    icon: (
      <svg
        ...
        role="img"
        fill="currentColor"
        className="h-6 w-6 //dark:text-[#61DAFB]"
      >
        <title>React</title>
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        role="img"
        fill="currentColor"
        className="h-6 w-6 //dark:text-[#06B6D4]"
      >
      ...
      <div className="flex flex-col items-center justify-center text-center md:items-start md:text-start">
        ...
        <div className="my-5 flex md:justify-start justify-center h-10 w-full flex-row space-x-2 overflow-x-auto">
          {data.map((item, id) => (
            <div
              key={id}
              className="flex h-15 w-10 items-center justify-between rounded border border-black bg-neutral-50 px-3 py-4 dark:border-neutral-700 dark:bg-neutral-800"
            >
              {item.icon}
            </div>
          ))}
